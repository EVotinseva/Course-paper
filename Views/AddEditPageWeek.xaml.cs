...
namespace MyFirstMauiApp.Views
{
    public partial class AddEditPageWeek : ContentPage
    {
        ...
        private bool _isFreeTask = false;

        public AddEditPageWeek(WeekViewModel viewModel, ScheduleItem editingItem = null, bool isFreeTask = false)
        {
            InitializeComponent();
            ...
            if (_editingItem != null)
            {
                ...
                // Если редактируем свободную задачу — скрываем выбор даты/времени
